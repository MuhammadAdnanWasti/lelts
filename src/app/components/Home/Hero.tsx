        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            >
              ...
              <span className="text-sm font-semibold text-slate-600 tracking-wide uppercase">AI-Powered Exam Simulator</span>
            </motion.div>
            ...
            >
              Stop guessing your score. Get instant, detailed feedback on your Writing and Speaking from our advanced AI. Prepare smarter, not harder.
            </motion.p>
             ...
             <div className="relative w-full max-w-md mx-auto">
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <p className="text-xs text-slate-500 font-semibold uppercase">Speaking</p>
                ...
                >
                  ...
                  <p className="text-sm text-slate-700 font-medium leading-snug">
                    &quot;The AI feedback is incredibly accurate. Helped me jump from 6.5 to 7.5!&quot;
                  </p>
                  <div className="mt-3 flex items-center gap-2">
                     <div className="w-6 h-6 rounded-full bg-slate-200 overflow-hidden">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix" alt="User" />
                     </div>
                     <span className="text-xs text-slate-500 font-bold">Sarah K.</span>
                  </div>
                </motion.div>
             </div>
          </motion.div>

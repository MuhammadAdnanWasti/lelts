        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-linear-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center shadow-sm">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Your ultimate destination for IELTS preparation. Master Reading, Writing, Listening, and Speaking with our comprehensive mock tests and expert guidance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/mock-tests" className="text-gray-400 hover:text-white transition-colors">Mock Tests</Link>
              </li>
              <li>
                <Link href="/practice" className="text-gray-400 hover:text-white transition-colors">Practice Materials</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Subscribe to our newsletter for the latest IELTS tips and exam updates.
            </p>
            <form className="space-y-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
              />
              <button
                type="submit"
